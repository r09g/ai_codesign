...
class MainStage:
    ...
    def run(self):
        answers = []
        # this iterates over every tuple generated by self.list_of_callables[0] stage
        # self.list_of_callables[0](self.list_of_callables[1:], **self.kwargs).run()
        #   stage is self.list_of_callables[0]
        #   list_of_callables is updated to list_of_callables[1:]
        #   run() is called which returns a generator
