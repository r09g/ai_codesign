...
class SpatialMappingGeneratorStage(Stage):
    ...
    def run(self):
        ...
        if (isinstance(user_provided_spatial_mappings, dict) and len(user_provided_spatial_mappings) > 0):  # There is a single USM provided
            user_spatial_mappings = [user_provided_spatial_mappings]
        elif (isinstance(user_provided_spatial_mappings, list) and len(user_provided_spatial_mappings) > 0):  # There are multiple USMs provided
            user_spatial_mappings = user_provided_spatial_mappings
